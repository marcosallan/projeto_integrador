 ...
 * @author JON
 */
public class TelaCadastraCoordenador extends javax.swing.JInternalFrame {

    public TelaCadastraCoordenador() {
        initComponents();
        carregaCombo();
    }
   ...
   public void LimparTela() {
        ...
        DefaultTableModel dtm = (DefaultTableModel) tblCoordenador.getModel();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblCoordenador);
        if (tblCoordenador.getColumnModel().getColumnCount() > 0) {
            tblCoordenador.getColumnModel().getColumn(0).setPreferredWidth(10);
            tblCoordenador.getColumnModel().getColumn(1).setPreferredWidth(150);
        }
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if (txtMatricula.getText().equals("   .   .   -  ")) {
            sql = "SELECT * FROM pessoa WHERE pes_funcao = 'Coordenador'";
    ...
    private void tblCoordenadorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCoordenadorMouseClicked
        ...
        int linhaSel = tblCoordenador.getSelectedRow();
        cmbUF.removeAllItems();
        cmbSituacao.removeAllItems();
        // percorre lista e mostra todas as contas
        ...
        for (Pessoa p : pessoa) {
            ...
            if (tblCoordenador.getValueAt(linhaSel, 0).equals(p.getPes_iden())) {
