...
public class TelaCadastraDisciplina extends javax.swing.JInternalFrame {
    ...
    public int buscaCurso(String nome, int id){
     String sql = "SELECT * FROM curso";
            ...
            Pilha pilhaCurso = new Pilha();
            for(Curso c : curso) {
                pilhaCurso.empilhar(c);
            }
            ...
            NoPilha noPilha = pilhaCurso.getUltimo();
            
            while (noPilha != null) {

                cmbCurso.addItem(noPilha.getInfo().getCurs_descricao());
                if(noPilha.getInfo().getCurs_descricao().equals(nome)){
                    iden = noPilha.getInfo().getCurs_iden();
                }
                if(noPilha.getInfo().getCurs_iden() == id){
                    cmbCurso.removeAllItems();
                    cmbCurso.addItem(noPilha.getInfo().getCurs_descricao());
                    return 0;
                }
...
//            }
    ...
    private void initComponents() {
        ...
        btnCadastra.setBackground(new java.awt.Color(0, 102, 0));
        ...
        btnLimpar.setBackground(new java.awt.Color(0, 255, 204));
