...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    public TelaPrincipal(Pessoa p) throws SQLException {
    ...
    private void initComponents() {
        ...
        jdpPrincipal.setLayer(jButtonLogin, javax.swing.JLayeredPane.DEFAULT_LAYER);
    ...
    private void acesso(Pessoa pessoa) {
        if("Aluno".equals(pessoa.getPes_funcao())) {
            btnAluno.setEnabled(true);
        }
        if("Professor".equals(pessoa.getPes_funcao())) {
            btnProfessor.setEnabled(true);
        }
        if("Coordenador".equals(pessoa.getPes_funcao())) {
            btnCoordenador.setEnabled(true);
        }
        if("RH".equals(pessoa.getPes_funcao())) {
            btnRH.setEnabled(true);
        }
        if("Secretaria".equals(pessoa.getPes_funcao())) {
